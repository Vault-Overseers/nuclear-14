...
FORK_ID = "n14"
BUILD_URL = f"https://builds.nuclear14.com/{{FORK_ID}}/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://cdn.nuclear14.com/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://cdn.nuclear14.com/version/{{FORK_VERSION}}/download"

...
bounty-description-lasergun = Караван мусорщиков запрашивает крупную партию лазерного оружия для зачистки гнезда ксеноморфов.
bounty-description-food = После нашествия крысиного короля, соседняя станция унатхи осталась полностью без еды. Требуется крупная поставка мясных продуктов.

...
ent-DiagnoserMachineCircuitboard = диагностировщик заболеваний (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-TraversalDistorterMachineCircuitboard = искажающая машина (машинная плата)
...
ent-ShuttleGunSvalinnMachineGunCircuitboard = пулемёт "Свалинн" (машинная плата)
    .desc = Печатная плата для пулемёта "Свалинн" LSE-400c.
ent-ShuttleGunPerforatorCircuitboard = перфоратор (машинная плата)
    .desc = Печатная плата для перфоратора LSE-1200c.
ent-ShuttleGunFriendshipCircuitboard = "Дружба" (машинная плата)
    .desc = Печатная плата для оружия "Дружба" EXP-320g.
ent-ShuttleGunDusterCircuitboard = "Дастер" (машинная плата)
    .desc = Печатная плата для оружия "Дастер" EXP-2100g.
ent-ShuttleGunKineticCircuitboard = дематериализатор материи (машинная плата)

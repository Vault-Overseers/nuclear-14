...
reagent-desc-extract-agave-nectar = agave nectar extract
reagent-name-extract-banana-yucca = banana yucca extract
reagent-desc-extract-banana-yucca = banana yucca extract
reagent-name-extract-blackberries = blackberry juice
reagent-desc-extract-blackberries = blackberry extract
reagent-name-extract-broc = broc flower extract
reagent-desc-extract-broc = broc flower extract
...
reagent-desc-extract-carrot = carrot juice
reagent-name-extract-coyote-tobacco = coyote tobacco extract
reagent-desc-extract-coyote-tobacco = coyote tobacco extract
reagent-name-extract-datura = datura extract
reagent-desc-extract-datura = datura extract
reagent-name-extract-honey-mesquite-pod = honey mesquite pod extract
reagent-desc-extract-honey-mesquite-pod = honey mesquite pod extract
reagent-name-extract-jalapeno-pepper = jalapeno pepper juice
reagent-desc-extract-jalapeno-pepper = jalapeno pepper juice
reagent-name-extract-maize = maize extract
reagent-desc-extract-maize = maize extract
reagent-name-extract-mutfruit = mutfruit juice
reagent-desc-extract-mutfruit = mutfruit juice
reagent-name-extract-pricky-pear-fruit = prickly pear juice
reagent-desc-extract-pricky-pear-fruit = prickly pear juice
reagent-name-extract-razorgrain = razorgrain flour
reagent-desc-extract-razorgrain = razorgrain flour
reagent-name-extract-starlight-berries = starlight berry juice
reagent-desc-extract-starlight-berries = starlight berry juice
reagent-name-extract-tarberries = tarberry juice
reagent-desc-extract-tarberries = tarberry juice
reagent-name-extract-tato = tato juice
reagent-desc-extract-tato = tato juice
reagent-name-extract-white-horsenettle = white horsenettle extract
reagent-desc-extract-white-horsenettle = white horsenettle extract
reagent-name-extract-xander = xander extract
reagent-desc-extract-xander = xander extract

...
damage-examine-armor-piercing = [color=yellow]Armor-piercing[/color] is [color=red]{$ignore}%[/color].
damage-examine-type-armor-piercing = [color=yellow]Armor-piercing[/color] for [color=cyan]{$type}[/color] is [color=red]{$ignore}[/color].

...
public sealed partial class RangedDamageSoundComponent : Component
{
    ...
    /// </summary>
    [DataField("soundGroups", customTypeSerializer: typeof(PrototypeIdDictionarySerializer<SoundSpecifier, DamageGroupPrototype>))]
    ...
    /// Will fallback to defaults if none specified.
    /// </summary>
    [DataField("soundTypes", customTypeSerializer: typeof(PrototypeIdDictionarySerializer<SoundSpecifier, DamageTypePrototype>))]

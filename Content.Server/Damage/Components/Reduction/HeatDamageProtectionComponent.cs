...
/// </summary>
[RegisterComponent]
public sealed partial class HeatDamageProtectionComponent : Component
{
    /// <summary>
    ///     The damage modifier for entities with this component.
    /// </summary>
    [DataField("modifier")]
    public ProtoId<DamageModifierSetPrototype> HeatDamageProtectionModifierSetId = "Puratide";
}
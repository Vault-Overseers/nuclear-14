...
/// </summary>
[RegisterComponent]
public sealed partial class PiercingDamageProtectionComponent : Component
{
    /// <summary>
    ///     The damage modifier for entities with this component.
    /// </summary>
    [DataField("modifier")]
    public ProtoId<DamageModifierSetPrototype> PiercingDamageProtectionModifierSetId = "Shelitide";
}
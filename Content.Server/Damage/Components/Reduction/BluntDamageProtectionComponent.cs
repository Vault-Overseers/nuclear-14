...
/// </summary>
[RegisterComponent]
public sealed partial class BluntDamageProtectionComponent : Component
{
    /// <summary>
    ///     The damage modifier for entities with this component.
    /// </summary>
    [DataField("modifier")]
    public ProtoId<DamageModifierSetPrototype> BluntDamageProtectionModifierSetId = "Boltide";
}
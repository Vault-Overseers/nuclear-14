...
/// </summary>
[RegisterComponent]
public sealed partial class ColdDamageProtectionComponent : Component
{
    /// <summary>
    ///     The damage modifier for entities with this component.
    /// </summary>
    [DataField("modifier")]
    public ProtoId<DamageModifierSetPrototype> ColdDamageProtectionModifierSetId = "Harnitide";
}
...
/// </summary>
[RegisterComponent]
public sealed partial class SlashDamageProtectionComponent : Component
{
    /// <summary>
    ///     The damage modifier for entities with this component.
    /// </summary>
    [DataField("modifier")]
    public ProtoId<DamageModifierSetPrototype> SlashDamageProtectionModifierSetId = "Thinitide";
}